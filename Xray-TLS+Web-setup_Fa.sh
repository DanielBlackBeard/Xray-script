...
#اطلاعات پیکربندی اتصال
# لیست نام دامنه دو لیست برای تشخیص نام دامنه www.main استفاده می شود
unset domain_list
unset true_domain_list
unset domain_config_list
# فهرست بالماسکه نام دامنه، لیست نام دامنه مربوطه
unset pretend_list
